...
# YS Video Downloader v2.8 - Defender-Optimized Build Spec
...
a = Analysis(
    ['../main.py'],  # Kök klasördeki ortak kaynak
    pathex=[],
    binaries=[],
    datas=[
...
exe = EXE(
    ...
    name='YS Video Downloader v2.8',  # ✅ EXE adı burada belirleniyor
    debug=False,
...
coll = COLLECT(
    ...
    upx=False,
    upx_exclude=[],
    name='YS Video Downloader v2.8',  # ✅ Klasör adı
)
