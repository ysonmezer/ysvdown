...
# YS Video Downloader v3.0 - Defender-Optimized Build Spec
...
exe = EXE(
    ...
    name='YS Video Downloader v3.0',  # ✅ EXE adı burada belirleniyor
    debug=False,
...
coll = COLLECT(
    ...
    upx=False,
    upx_exclude=[],
    name='YS Video Downloader v3.0',  # ✅ Klasör adı
)
